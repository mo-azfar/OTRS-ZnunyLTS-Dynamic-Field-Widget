...
# Copyright (C) 2021 mo-azfar, https://github.com/mo-azfar/OTRS-ZnunyLTS-Dynamic-Field-Widget
# --
...
sub MaskAgentZoom {
    ...
    # ---
    # show process widget on normal tickets
    if (!defined $IsProcessTicket) {

    $Param{WidgetTitle} = "Ticket Dynamic Field Information";
    ...
    # output the process widget on normal ticket in the main screen
    $LayoutObject->Block(
        Name => 'ProcessWidget',
        Data => {
            WidgetTitle => $Param{WidgetTitle},
    ...
    # OTRS-ZnunyLTS-Dynamic-Field-Widget
    # ---
    if ($IsProcessTicket || !defined $IsProcessTicket) {
    #if ($IsProcessTicket) {
    # ---
